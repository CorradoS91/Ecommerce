...
public class DatabaseSeeder {
    ...
    public void seedDatabase() {
        if (userRepository.count() == 0) {
            ...
            Address address1 = new Address("Via Roma, 10", "Milano", "20100", "Italia", new HashSet<>());
            Address address2 = new Address("Piazza Duomo, 5", "Roma", "00100", "Italia", new HashSet<>());
            ...
            userRepository.getUserByEmail(user1.getEmail());
            userRepository.getUserByEmail(user2.getEmail());
